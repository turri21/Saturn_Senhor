...
Not needed: For ST-V using a reworked STV.sdc as well as this line in files.qip "set_global_assignment -name SDC_FILE STV.sdc". To synthesize use Quartus 23.
